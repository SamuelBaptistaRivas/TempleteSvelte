    ...
    <div class="relative">
        ...
        {#if selected}
          <span class="w-full inline-flex truncate">
            ...
            {:else}
              <div class="flex justify-between space-x-2 w-full">
                <div class="font-normal truncate">
                  {selected.providerWorkspace.name}
                </div>
                <div class="text-gray-500">
                  <span
      ...
      {#if opened}
        ...
        >
          ...
          {#if loading}
            <div class="py-2 px-3 text-gray-400 text-sm">
              {$t("shared.loading")}...
            </div>
