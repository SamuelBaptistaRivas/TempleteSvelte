...
<div class="space-y-2 w-full">
  ...
  >
    <ButtonPrimary on:click={() => alert("Clicked primary button")}
      >Primary</ButtonPrimary
    >
    <ButtonSecondary on:click={() => alert("Clicked secondary button")}
      >Secondary</ButtonSecondary
    >
    <ButtonTertiary on:click={() => alert("Clicked tertiary button")}
      >Tertiary</ButtonTertiary
    >
    <LoadingButton bind:this={loadingButton} on:click={() => startLoading()}
