...
<div class={className}>
  <div
    class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8"
  >
    <div>
      <h2
      ...
      >
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.frontend.components.title")}
            </p>
          </dt>
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.frontend.routes.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.frontend.i18n.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.frontend.store.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.frontend.tailwindcss.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.frontend.classComponents.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
              alt="svelte-components"
              class="w-full h-20 shadow-lg border border-gray-200 dark:border-slate-800 rounded-md object-cover"
              src="https://yahooder.sirv.com/saasfrontends/features/svelte-components.jpg"
            />
            <div>
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.frontend.fakeApi.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.frontend.eslint.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
              alt="Svelte Check"
              class="w-full h-20 shadow-lg border border-gray-200 dark:border-slate-800 rounded-md object-cover"
              src="https://yahooder.sirv.com/saasfrontends/features/svelte-check.jpg"
            />
            <div>
  ...
  >
    <div>
      <h2
        class="text-base font-semibold text-theme-600 uppercase tracking-wide"
      >
        {$t("front.features.backend.hint")}
      </h2>
      <p class="mt-2 text-3xl font-extrabold">
        {$t("front.features.backend.title")}
      </p>
      <p class="mt-4 text-lg text-gray-500">
        {$t("front.features.backend.description")}
      </p>
    </div>
    <div class="mt-12 lg:mt-0 lg:col-span-2">
      <dl
      ...
      >
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.backend.features.net.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.backend.features.cleanArchitecture.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
            ...
            <div>
              {$t(
                "front.features.backend.features.cleanArchitecture.description"
              )}
            </div>
          </dd>
        </div>
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.backend.features.tests.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.backend.features.multiTenant.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
            ...
            />
            <div>
              {$t("front.features.backend.features.multiTenant.description")}
            </div>
          </dd>
        </div>
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.backend.features.memberManagement.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
            ...
            <div>
              {$t(
                "front.features.backend.features.memberManagement.description"
              )}
            </div>
          </dd>
        </div>
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.backend.features.stripe.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.backend.features.postmark.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium">
              {$t("front.features.backend.features.ef.title")}
            </p>
          </dt>
          <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
            <img
