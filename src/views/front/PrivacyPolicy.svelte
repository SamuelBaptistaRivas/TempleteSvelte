...
<svelte:head>
  <title>{$t("front.privacy.title")} | {$t("shared.websiteTitle")}</title>
</svelte:head>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:flex-col sm:align-center space-y-4">
          <div class="text-gray-500 prose mx-auto">
            ...
            <p>
              Your privacy is important to us. It is SaasFrontends&#39; policy
            ...
            <p>
              This policy is effective as of 14 December 2021 and was last
