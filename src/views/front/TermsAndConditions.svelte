...
<svelte:head>
  <title>{$t("front.terms.title")} | {$t("shared.websiteTitle")}</title>
</svelte:head>
        ...
        <div class="sm:flex sm:flex-col sm:align-center space-y-4">
          <div class="prose mx-auto text-gray-500">
            ...
            <p>
              ...
              webpage shall manage your use of our website, SaasFrontends
              accessible at saasfrontends.com.
            </p>
            ...
            <p>
              Other than the content you own, under these Terms, SaasFrontends
            ...
            <p>
              ...
              you and SaasFrontends may further restrict access by you to any
            ...
            <p>
              ...
              Content, you grant SaasFrontends a non-exclusive, worldwide
            ...
            <p>
              ...
              third-party’s rights. SaasFrontends reserves the right to remove
            ...
            <p>
              ...
              SaasFrontends express no representations or warranties, of any
            ...
            <p>
              In no event shall SaasFrontends, nor any of its officers,
              ...
              whether such liability is under contract. SaasFrontends, including
            ...
            <p>
              You hereby indemnify to the fullest extent SaasFrontends from and
            ...
            <p>
              SaasFrontends is permitted to revise these Terms at any time as it
            ...
            <p>
              The SaasFrontends is allowed to assign, transfer, and subcontract
            ...
            <p>
              These Terms constitute the entire agreement between SaasFrontends
